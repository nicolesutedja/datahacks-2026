  ...
  return (
    <div className="size-full relative overflow-hidden bg-slate-950">
      ...
      <div className="relative z-10 size-full flex flex-col items-center justify-center gap-12 px-8 pointer-events-none h-screen">
        ...
        >
          <div className="flex items-center justify-center mb-6">
            <motion.img
              ...
              style={{
                filter: 'brightness(0) saturate(100%) invert(27%) sepia(93%) saturate(3571%) hue-rotate(349deg) brightness(95%) contrast(91%)',
              }}
              animate={{
                scale: [1, 1.05, 1],
              }}
          ...
          <h1 className="text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-red-600 to-red-700 mb-3 tracking-tighter" style={{ fontFamily: 'Orbitron, sans-serif' }}>
            SEISMICSIMULATOR
          </h1>
          <p className="text-red-500/40 text-xs uppercase tracking-[0.3em] font-medium" style={{ fontFamily: 'Rajdhani, sans-serif' }}>
        ...
        >
          {/* Hooked up to start the pre-defined scenario (La Jolla) */}
          <PulseButton
            variant="primary"
          ...
          {/* Hooked up to start the sandbox map */}
          <PulseButton
            variant="secondary"
        ...
        >
          <div className="flex items-center gap-3 text-red-900/40 text-xs">
            ...
            <span className="uppercase tracking-[0.2em] font-medium">System Online</span>
          </div>
        </motion.div>
      </div>
    </div>
